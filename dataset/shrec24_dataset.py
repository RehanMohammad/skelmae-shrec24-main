...
if __name__ == '__main__':
    ...
    dataset = PretrainingDataset(data_dir='D:\\Dataset\\Data Split\\Data Split\\Train-set', normalize=True)
    loader = DataLoader(dataset, batch_size=4, shuffle=True)

    batch = next(iter(loader))
    print('Batch shape:', batch['Sequence'].shape)

    print('\nFinetuning dataset:')
    dataset = FinetuningDataset(data_dir='D:\\Dataset\\Data Split\\Data Split\\Train-set', T=3000, normalize=True)
    loader = DataLoader(dataset, batch_size=4, shuffle=True)
